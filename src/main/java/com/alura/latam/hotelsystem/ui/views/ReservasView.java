...
public class ReservasView extends JFrame {
	...
	private String imageClassPath = "/com/alura/latam/hotelsystem/ui/images/";
	...
	private String reservationNumber, paymentType;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ReservasView frame = new ReservasView(null, null);
	 ...
	 * Create the frame.
	 */
	public ReservasView(ReservationController reservationController, 
		...
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource(imageClassPath + "aH-40px.png")));
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource(imageClassPath + "Ha-100px.png")));

		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource(imageClassPath + "reservas-img-3.png")));
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				MenuPrincipal principal = new MenuPrincipal(
						ReservasView.this.reservationController,
						ReservasView.this.guestController);
		...
		txtFechaEntrada.getCalendarButton()
				.setIcon(new ImageIcon(ReservasView.class.getResource(imageClassPath + "icon-reservas.png")));
		...
		txtValorReserva.setBounds(68, 328, 289, 33);
		...
		txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				amount = calcuteReservationAmount(
						txtFechaEntrada.getDate(), txtFechaSalida.getDate());
				txtValorReserva.setText(formatStringToCurrency(amount));
			}
		});
	...
	private BigDecimal calcuteReservationAmount(Date checkIn, Date checkOut) {
		checkInDate = LocalDateUtil.convert(checkIn);
		checkOutDate = LocalDateUtil.convert(checkOut);
		return reservationController.getAmount(checkInDate, checkOutDate);
	}
	
	private String formatStringToCurrency(BigDecimal value) {
	...
	private void createReservation() {
		reservationNumber = reservationController.getNumber();
		checkInDate = LocalDateUtil.convert(txtFechaEntrada.getDate());
		checkOutDate = LocalDateUtil.convert(txtFechaSalida.getDate());
		paymentType = txtFormaPago.getSelectedItem().toString();
		var reservationCreationData = new ReservationCreationData(
				reservationNumber,
				checkInDate,
				checkOutDate,
				amount, 
		...
		var reservationDetails = reservationController.saveEntity(reservationCreationData);
		
		if (reservationDetails.id() != null) {
			var creationMessage = "Reservación No. "
					+ reservationDetails.reservationNumber()
					+ " creada exitosamente";
			JOptionPane.showMessageDialog(null, creationMessage);
			RegistroHuesped registro = new RegistroHuesped(
					reservationDetails, reservationController, guestController);
			registro.setVisible(true);
			dispose();
		} else {
			JOptionPane.showMessageDialog(null, reservationDetails.validationError());
		}
	}
