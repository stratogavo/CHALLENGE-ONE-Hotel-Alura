...
public class MenuUsuario extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MenuUsuario frame = new MenuUsuario(null, null);
	 ...
	 * Create the frame.
	 */
	public MenuUsuario(ReservationController reservationController, 
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource(imageClassPath + "aH-40px.png")));
		...
		lblNewLabel_2.setIcon(new ImageIcon(MenuUsuario.class.getResource(imageClassPath + "aH-150px.png")));
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				ReservasView reservas = new ReservasView(
						MenuUsuario.this.reservationController, 
						MenuUsuario.this.guestController);
		...
		labelRegistro.setIcon(new ImageIcon(MenuUsuario.class.getResource(imageClassPath + "reservado.png")));
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				Busqueda busqueda = new Busqueda(reservationController,
						guestController);
		...
		lblBusquedaDeReservas.setIcon(new ImageIcon(MenuUsuario.class.getResource(imageClassPath + "pessoas.png")));
		...
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				MenuUsuario.this.reservationController.closeConnection();
				MenuUsuario.this.guestController.closeConnection();
				System.exit(0);
			}
