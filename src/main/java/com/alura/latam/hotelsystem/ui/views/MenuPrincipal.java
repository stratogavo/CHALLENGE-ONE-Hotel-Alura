...
public class MenuPrincipal extends JFrame {
	 ...
	 * Create the frame.
	 */
	public MenuPrincipal(ReservationController reservationController, 
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(MenuPrincipal.class
						.getResource(imageClassPath + "aH-40px.png")));
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class
				.getResource(imageClassPath + "menu-img.png")));
		panel.add(imagenFondo);

		JLabel logo = new JLabel("");
		logo.setBounds(722, 80, 150, 156);
		logo.setIcon(new ImageIcon(MenuPrincipal.class
				.getResource(imageClassPath + "aH-150px.png")));
		panel.add(logo);
		...
		JLabel lblCopyR = new JLabel("Desarrollado por Gerardo Velasco © 2023");
		lblCopyR.setBounds(315, 11, 294, 19);
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				MenuPrincipal.this.reservationController.closeConnection();
				MenuPrincipal.this.guestController.closeConnection();
				System.exit(0);
			}
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Login login = new Login(
						MenuPrincipal.this.reservationController, 
						MenuPrincipal.this.guestController);
		...
		imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource(imageClassPath + "login.png")));
