...
public class Login extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Login(ReservationController reservationController, 
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource(imageClassPath + "img-hotel-login-.png")));
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				Login.this.reservationController.closeConnection();
				Login.this.guestController.closeConnection();
				System.exit(0);
			}
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource(imageClassPath + "lOGO-50PX.png")));
	...
	private void loginControl() {
		...
		if (txtUsuario.getText().equals(Usuario) && contrase.equals(Contraseña)) {
			MenuUsuario menu = new MenuUsuario(
					Login.this.reservationController, 
					Login.this.guestController);
