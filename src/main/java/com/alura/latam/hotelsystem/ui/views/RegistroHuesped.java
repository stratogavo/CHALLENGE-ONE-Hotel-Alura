...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(ReservationDetails reservationDetails, 
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage(RegistroHuesped.class.getResource(imageClassPath + "lOGO-50PX.png")));
		...
		header.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				MenuPrincipal principal = new MenuPrincipal(
						RegistroHuesped.this.reservationController,
						RegistroHuesped.this.guestController);
		...
		txtFechaN.getCalendarButton()
				.setIcon(new ImageIcon(RegistroHuesped.class.getResource(imageClassPath + "icon-reservas.png")));
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel<String>(
				new String[] {"afgano-afgana", "alemán-alemana",
		...
		txtNreserva = new JTextField(reservationDetails.reservationNumber());
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource(imageClassPath + "registro.png")));

		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource(imageClassPath + "Ha-100px.png")));
	...
	private void createGuest() {
		var name = txtNombre.getText();
		var surname = txtApellido.getText();
		var dateOfBirth = LocalDateUtil.convert(txtFechaN.getDate());
		var nationality = txtNacionalidad.getSelectedItem().toString();
		var phoneNumber = txtTelefono.getText();
		var guestCreationData = new GuestCreationData(
				name,
				surname,
				dateOfBirth,
				nationality,
		...
		var guestDetails = guestController.saveEntity(guestCreationData);
		
		if (guestDetails.id() != null) {
			var guest = new Guest(guestDetails);
			var reservation = new Reservation(reservationDetails);
			reservationController.addGuest(reservation, guest);
			var successMessageDialog = new Exito(
					this, this.reservationController, this.guestController);
			successMessageDialog.setVisible(true);
		} else  {
			JOptionPane.showMessageDialog(null, guestDetails.validationError());
		}
	}
}
